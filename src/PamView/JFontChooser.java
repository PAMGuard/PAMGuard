...
public class JFontChooser extends JComponent
{
	...
	private static final Font DEFAULT_SELECTED_FONT = new Font("Serif", Font.PLAIN, 16);
//	private static final Font DEFAULT_FONT = new Font("Dialog", Font.PLAIN, 14);
	...
	protected JPanel getFontFamilyPanel()
	{
		if (fontNamePanel == null)
		{
			...
			fontNamePanel.setPreferredSize(new Dimension(360, 260));
	...
	protected JPanel getFontStylePanel()
	{
		if (fontStylePanel == null)
		{
			...
			fontStylePanel.setPreferredSize(new Dimension(280, 260));
	...
	protected JPanel getFontSizePanel()
	{
		if (fontSizePanel == null)
		{
			...
			fontSizePanel.setPreferredSize(new Dimension(140, 260));
	...
	protected JTextField getSampleTextField()
	{
		if (sampleText == null)
		{
			...
			sampleText.setPreferredSize(new Dimension(600, 200));
		}
		return sampleText;
	}
