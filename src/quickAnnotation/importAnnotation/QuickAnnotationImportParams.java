...
public class QuickAnnotationImportParams implements Serializable, Cloneable {
...
//	HydrophoneLocatorSystem hydropheonLocator=HydrophoneLocators.getInstance().getSystem(0);
	...
	@Override
	public QuickAnnotationImportParams clone() {
		try {
			return(QuickAnnotationImportParams) super.clone();
		}
