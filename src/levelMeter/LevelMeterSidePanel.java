...
public class LevelMeterSidePanel extends PamObserverAdapter implements PamSidePanel  {
	...
	public LevelMeterSidePanel(LevelMeterControl levelMeterControl) {
		...
		minLab = new PamLabel(" ", SwingConstants.LEFT);
		scaleLab = new PamLabel(" ", SwingConstants.CENTER);
		maxLab = new PamLabel("0", SwingConstants.RIGHT);
...
//		PamDialog.addComponent(mainPanel, maxLab, c);
		...
		for (int i = 0; i < PamConstants.MAX_CHANNELS; i++) {
			...
			c.gridx = 0;
			c.gridwidth = 1;
			PamDialog.addComponent(mainPanel, chLab[i] = new PamLabel(String.format("%d", i), SwingConstants.LEFT), c);
			c.gridx = 1;
			c.gridwidth = 3;
