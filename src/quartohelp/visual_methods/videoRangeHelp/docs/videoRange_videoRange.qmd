...
title: "Setup"
---
 Video Range Measuring to a Shoreline  
...
The method can also be applied from land stations (an application for which theodolites are traditionally employed.) When used from land station its necessary to configure PAMGUARD with a fixed stationary array. Instruction on setting up PAMGUARD in this mode are found [here.](../../../utilities/hydrophoneArrayManagerHelp/docs/Array_Configuration.html)
...
[Next: Adding and Setting up a New Video Range Module](VideoRange_SidePanel.html)
