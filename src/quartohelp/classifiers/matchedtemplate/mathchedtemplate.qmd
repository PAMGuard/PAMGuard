...
_threshold_ is the threshold at which a click is classified. If the difference between the match and reject templates is above the _threshold_ value then the click is classified.
