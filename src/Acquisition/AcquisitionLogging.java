...
public class AcquisitionLogging extends SQLLogging {
	...
	gain, duration, clockError, samples, gSamples, GPSPPSTime, serverTime, daqSystemName, startClockSource;
	...
	public AcquisitionLogging(PamDataBlock pamDataBlock, AcquisitionControl acquisitionControl) {
		...
		tableDef.addTableItem(startClockSource = new PamTableItem("ADC Clock Reference", Types.CHAR, 50));
...
//	}
	...
	public void setTableData(SQLTypes sqlTypes, PamDataUnit pamDataUnit) {
		...
		startClockSource.setValue(ds.getStartTimeSource());
