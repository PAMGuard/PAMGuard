...
public interface TargetMotionInformation {
	...
	/**
	 * Convert Euler angles into heading vectors.
	 * (Moved from the deleted targetMotionModule.AbstractTargetMotionInformation.)
	 * @param eulerAngles Euler angles for each detection.
	 * @return unit heading vectors.
	 */
