...
/*
 * Downloaded 28 Feb 2016 from http://www.ngdc.noaa.gov/geomag/WMM/thirdpartycontributions.shtml
 * Minor modifications to change logging and to change way that WMM.COF file is opened. 
 * 
 */
...
//            InputStream input = getClass().getResourceAsStream("WMM.COF");
            ...
            System.out.println("TSAGeoMag Epoch is: " + epoch);
            System.out.println("TSAGeoMag default date is: " + defaultDate);
            str.nextToken();
            //strModel = str.sval;
            str.nextToken();
