 ...
 */
public class RissosClickTest {
	
	/**
	 * Test just one click using the zipped classifier. Performs all the steps needed to run a click through PAMGuard DL classifier
	 * 
	 */
	@Test
	public void aclickDLTestZip()   {
		...
		String relModelPath  =	"./src/test/resources/rawDeepLearningClassifier/Generic/rissos_dolphin_click/model_pb.zip";
		String clicksPath  =	"./src/test/resources/rawDeepLearningClassifier/Generic/rissos_dolphin_click/example_2000021.mat";
