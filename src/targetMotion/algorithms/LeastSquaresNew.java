 ...
 * @param <T>
 */
public class LeastSquaresNew<T extends DetectionGroup> extends AbstractTargetMotionModel<T> {
...
//		}
	...
	public GroupLocResult[] runModel(T pamDetection) {
		...
		groupDetection = new DetectionGroup<PamDataUnit>(pamDetection.getSubDetection(0));
