...
public class Simplex3D  extends AbstractTargetMotionModel {
	...
	public Simplex3D(TargetMotionLocaliser targetMotionLocaliser) {
...
//				}
				...
				tmResults[side].setBeamLatLong(new GpsData(oll));
				...
				tmResults[side].setReferenceHydrophones(targetMotionInformation.getReferenceHydrophones());
