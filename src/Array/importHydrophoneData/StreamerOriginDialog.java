...
public class StreamerOriginDialog extends PamDialog {
	...
	public StreamerOriginDialog(Window parentFrame, StreamerImportParams params) {
		super(parentFrame, "Streamer Import Settings", false);
		this.params=params;
	...
	private static StreamerOriginDialog singleInstance;
	
	private StreamerImportParams params;
	

	public static StreamerImportParams showDialog(Frame parentFrame, StreamerImportParams params) {
		if (singleInstance == null || parentFrame != singleInstance.getOwner()) {
			singleInstance = new StreamerOriginDialog(parentFrame,params);
		}
		if (singleInstance.params == null) {
			singleInstance.params = new StreamerImportParams();
		}
		else {
