...
public interface TDSymbolChooser {
	...
	/**
	 * Flag for a highlighted symbol. Generally this particular highlight is used if a data unit has been sleected as a part of a group of data units, e.g. by a zoomer. In ths
	 * case applying individual highlights may clutter the display and so a more light weight highlight or no highlight at all may be appropriate,  
	 */
